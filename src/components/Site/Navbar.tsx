        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-8">
              <Link
                href="/#hem"
                className="text-white hover:text-gray-100 px-3 py-2 text-sm font-medium transition-colors"
              >
                Hem
              </Link>
              <Link
                href="/produkter"
                className="text-gray-400 hover:text-gray-100 px-3 py-2 text-sm font-medium transition-colors"
              >
                Produkter
              </Link>
              <Link
